...
local TEXT =
{
    zh =
    {
        initialized = "已初始化：%d 个唯一原版事件（%d 条定义，%d 个重复事件），架构=声音事件+复制动作混合桥接，原生输出已抑制",
    ...
    en =
    {
        initialized = "initialized: %d unique native events (%d definitions, %d duplicate events), architecture=sound + replicated-action hybrid bridge, native output suppressed",
